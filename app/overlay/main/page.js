...
function MainOverlayContent() {
  ...
  useEffect(() => {
    ...
    // Reconnect every 30s to prevent stale connections
      ...
      <>
        ...
        <main style={{
          ...
          <div style={{ textAlign: 'center', zIndex: 10 }}>
            <p style={{ color: by.killsColor || '#9ca3af', fontWeight: 700, fontSize: '18px', letterSpacing: '8px', textTransform: 'uppercase', marginBottom: '16px', fontFamily: 'monospace', animation: 'booyahWinnerFade 0.8s ease forwards' }}>
              WINNER WINNER
            </p>
            <h1 style={{
              color: by.booyahColor || '#10b981',
              fontSize: 'clamp(80px, 12vw, 160px)',
              fontWeight: 900, lineHeight: 1, margin: '0 0 24px', letterSpacing: '-2px',
              fontFamily: "'Rajdhani', 'Arial Black', sans-serif", textTransform: 'uppercase',
            ...
            <div style={{
              ...
              borderRadius: '8px', padding: '20px 48px',
              ...
              <h2 style={{ color: by.winnerColor || '#ffffff', fontSize: 'clamp(32px, 5vw, 56px)', fontWeight: 900, margin: 0, letterSpacing: '4px', fontFamily: "'Rajdhani', 'Arial Black', sans-serif", textTransform: 'uppercase' }}>
                {winner?.name}
              </h2>
              <p style={{ color: by.killsColor || '#9ca3af', fontSize: '18px', marginTop: '8px', fontFamily: 'monospace', letterSpacing: '2px' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, fontWeight: 800, letterSpacing: '5px', textTransform: 'uppercase', color: '#c9a84c' }}>
                ...
                return (
                  <div key={team.id} style={{
                    animation: final4Visible
                      ...
                      : 'none',
                    flex: '1', maxWidth: '220px', minWidth: '130px',
                    position: 'relative', overflow: 'hidden',
                    background: theme?.card_bg_image
                      ? `linear-gradient(rgba(0,0,0,${1 - (theme?.card_image_opacity || 30) / 100}),rgba(0,0,0,${1 - (theme?.card_image_opacity || 30) / 100})),url(${theme.card_bg_image})`
                      : 'transparent',
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginBottom: '5px' }}>
                      <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 10, fontWeight: 900, letterSpacing: '2px', color: rc, textTransform: 'uppercase' }}>
                    ...
                    <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                      {Array.from({ length: totalPl }, (_, i) => (
                        <div key={i} style={{
                          flex: 1, height: i < alivePl ? '5px' : '3px', borderRadius: '2px',
                    ...
                    <div style={{ marginTop: '6px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 9, letterSpacing: '2px', textTransform: 'uppercase', color: 'rgba(201,168,76,0.4)' }}>PTS</span>
                      <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 14, fontWeight: 900, color: rc, letterSpacing: '1px' }}>
                        {team.matchTotal}
                      </span>
                    </div>
                  </div>
                ...
                return (
                  <div key={team.id} className="grid items-center relative overflow-hidden" style={{
                    ...
                    <div className="px-2 flex items-center">
                      <p style={{ fontSize: 14, fontWeight: 800, letterSpacing: '1.5px', textTransform: 'uppercase', color: isElim ? 'rgba(240,236,224,0.35)' : '#f0ece0', lineHeight: 1, fontFamily: "'Barlow Condensed', sans-serif", whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                        {team.name}
                      </p>
                    </div>
